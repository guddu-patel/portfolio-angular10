...
@Component({
  selector: 'app-admin-addupdate-post',
  templateUrl: './admin-addupdate-post.component.html',
  styleUrls: ['./admin-addupdate-post.component.scss']
})
export class AdminAddupdatePostComponent implements OnInit {
